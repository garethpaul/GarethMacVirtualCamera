...
The value must be a positive `s`, `m`, `h`, or `d` duration no greater than 24
hours. The app path argument must be an absolute path ending in `.app`.
