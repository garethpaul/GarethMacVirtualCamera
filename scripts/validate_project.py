...
"""
    ...
    require("GARETH_DIAGNOSTICS_SELF_TEST=executable-readiness" in runtime_diagnostics_test_source and "Executable missing name fixture: no" in runtime_diagnostics_test_source and "Executable missing file fixture: no" in runtime_diagnostics_test_source and "Executable non-executable fixture: no" in runtime_diagnostics_test_source and "Executable ready fixture: yes" in runtime_diagnostics_test_source,
            ...
            failures)
    require("GARETH_DIAGNOSTICS_SELF_TEST=application-identity" in runtime_diagnostics_test_source and "App path match fixture: yes" in runtime_diagnostics_test_source and "App path mismatch fixture: no" in runtime_diagnostics_test_source and "Application location existing fixture: yes" in runtime_diagnostics_test_source and "Application location missing fixture: no" in runtime_diagnostics_test_source and "Application location mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle identifier match fixture: yes" in runtime_diagnostics_test_source and "Bundle identifier mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle identifier missing fixture: no" in runtime_diagnostics_test_source and "Info.plist string metadata fixture: com.example.StringMetadata" in runtime_diagnostics_test_source and "Info.plist scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested string metadata fixture: com.example.StringMetadata.Extension" in runtime_diagnostics_test_source and "Info.plist nested scalar metadata fixture: missing" in runtime_diagnostics_test_source,
            "runtime diagnostics test should cover application path, bundle identifier, and typed Info.plist metadata comparisons",
            failures)
    require("read_plist_string_value" in runtime_diagnostics_source and "if isinstance(value, str) and value:" in runtime_diagnostics_source and "Info.plist scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested scalar metadata fixture: missing" in runtime_diagnostics_test_source and "test_validator_rejects_missing_runtime_diagnostics_info_plist_string_guard" in validate_project_test_source,
