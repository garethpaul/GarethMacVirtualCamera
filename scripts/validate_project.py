...
def expected_icon_pixel_size(image):
    ...
    try:
        ...
        scale = int(scale_value.removesuffix("x"))
    except ValueError:
        return None
...
"""
    ...
    require("CI-equivalent unsigned compile" in readme_text and "./scripts/build_unsigned.sh" in readme_text and "./scripts/scan_build_log.py .build/Xcode/Logs/build-Debug.log .build/Xcode/Logs/build-Release.log" in readme_text and ".build/Xcode" in readme_text and ".build/Xcode/Logs" in readme_text and "BUILD_OUTPUT_PATH" in readme_text and "BUILD_LOG_PATH" in readme_text,
            ...
            failures)
    require("runs `make check`, performs unsigned Debug and Release target builds" in readme_text and "verifies the built app products contain the embedded system extension, aligned bundle versions, declared executables, display metadata, product-specific privacy usage strings, bundled runtime diagnostics self-tests, resolved CoreMediaIO extension metadata, and bundled-video metadata" in readme_text and "captures the Xcode logs under `.build/Xcode/Logs`" in readme_text and "scans any captured `build-*.log` output including partial logs from failed builds" in readme_text and "build-failed, archive-failed, and test-failed banners" in readme_text,
    ...
    require("APP_CAMERA_USAGE_DESCRIPTION" in verify_build_products_source and "APP_SYSTEM_EXTENSION_USAGE_DESCRIPTION" in verify_build_products_source and "EXTENSION_CAMERA_USAGE_DESCRIPTION" in verify_build_products_source and "EXTENSION_SYSTEM_EXTENSION_USAGE_DESCRIPTION" in verify_build_products_source and "verify_info_plist_value \"$configuration\" \"app\" \"$app_path\" \"NSCameraUsageDescription\"" in verify_build_products_source and "verify_info_plist_value \"$configuration\" \"extension\" \"$extension_path\" \"NSCameraUsageDescription\"" in verify_build_products_source,
            ...
            failures)
    require("isinstance(value, str) and value.strip()" in verify_build_products_source and "set_info_plist_boolean_key" in verify_build_products_test_source and "non-string app display name" in verify_build_products_test_source and "blank app display name" in verify_build_products_test_source and "test_validator_rejects_missing_build_product_blank_info_plist_guard" in validate_project_test_source,
    ...
    require("write_product_fixture" in verify_build_products_test_source and "write_executable_fixture" in verify_build_products_test_source and "remove_info_plist_key" in verify_build_products_test_source and "set_info_plist_key" in verify_build_products_test_source and "cp \"$ROOT/scripts/collect_runtime_diagnostics.sh\"" in verify_build_products_test_source and "cp \"$ROOT/scripts/validate_project.py\"" in verify_build_products_test_source and "cp \"$ROOT/Extension/video.mp4\"" in verify_build_products_test_source and "Missing Debug app product" in verify_build_products_test_source and "Missing Debug embedded system extension" in verify_build_products_test_source and "com.example.WrongExtension" in verify_build_products_test_source and "Unexpected Debug extension bundle identifier" in verify_build_products_test_source and "Missing Debug app CFBundleDisplayName" in verify_build_products_test_source and "blank app display name" in verify_build_products_test_source and "Missing Debug extension CFBundleDisplayName" in verify_build_products_test_source and "Unexpected Debug app CFBundleDisplayName" in verify_build_products_test_source and "Unexpected Debug extension CFBundleDisplayName" in verify_build_products_test_source and "Missing Debug app NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Missing Debug extension NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Missing Debug app NSCameraUsageDescription" in verify_build_products_test_source and "Missing Debug extension NSCameraUsageDescription" in verify_build_products_test_source and "Unexpected Debug app NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Unexpected Debug extension NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Unexpected Debug app NSCameraUsageDescription" in verify_build_products_test_source and "Unexpected Debug extension NSCameraUsageDescription" in verify_build_products_test_source and "Missing Debug app runtime diagnostics script" in verify_build_products_test_source and "Missing Debug app runtime diagnostics parser" in verify_build_products_test_source and "Missing or empty Debug bundled video resource" in verify_build_products_test_source and "Missing Debug bundled video dimensions" in verify_build_products_test_source and "unparsable bundled video metadata" in verify_build_products_test_source and "Missing or non-executable Debug app executable" in verify_build_products_test_source and "non-executable app binary" in verify_build_products_test_source and "Missing or non-executable Debug extension executable" in verify_build_products_test_source and "non-executable extension binary" in verify_build_products_test_source and "Missing Debug app CFBundleExecutable" in verify_build_products_test_source and "missing app executable declaration" in verify_build_products_test_source and "Missing Debug extension CFBundleExecutable" in verify_build_products_test_source and "missing extension executable declaration" in verify_build_products_test_source and "Missing Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "blank CMIO extension metadata" in verify_build_products_test_source and "Unresolved Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "Unexpected Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "com.example.WrongMachService" in verify_build_products_test_source and "com.example.$EXTENSION_ID" in verify_build_products_test_source and "dotted-prefix CMIO extension metadata" in verify_build_products_test_source and "Mismatched Debug bundle short versions" in verify_build_products_test_source and "Mismatched Debug bundle build versions" in verify_build_products_test_source and "Build-product verifier tests passed." in verify_build_products_test_source,
            ...
            failures)
    require("isinstance(cmio_extension, dict)" in verify_build_products_source and "isinstance(mach_service_name, str) and mach_service_name.strip()" in verify_build_products_source and "set_extension_mach_service_boolean" in verify_build_products_test_source and "non-string CMIO extension metadata" in verify_build_products_test_source and "blank CMIO extension metadata" in verify_build_products_test_source and "test_validator_rejects_missing_build_product_blank_cmio_guard" in validate_project_test_source,
    ...
    require("GARETH_DIAGNOSTICS_SELF_TEST=executable-readiness" in runtime_diagnostics_test_source and "Executable missing name fixture: no" in runtime_diagnostics_test_source and "Executable missing file fixture: no" in runtime_diagnostics_test_source and "Executable non-executable fixture: no" in runtime_diagnostics_test_source and "Executable ready fixture: yes" in runtime_diagnostics_test_source,
            ...
            failures)
    require("GARETH_DIAGNOSTICS_SELF_TEST=application-identity" in runtime_diagnostics_test_source and "App path match fixture: yes" in runtime_diagnostics_test_source and "App path mismatch fixture: no" in runtime_diagnostics_test_source and "Application location existing fixture: yes" in runtime_diagnostics_test_source and "Application location missing fixture: no" in runtime_diagnostics_test_source and "Application location mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle identifier match fixture: yes" in runtime_diagnostics_test_source and "Bundle identifier mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle identifier missing fixture: no" in runtime_diagnostics_test_source and "Info.plist string metadata fixture: com.example.StringMetadata" in runtime_diagnostics_test_source and "Info.plist scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist blank string metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested string metadata fixture: com.example.StringMetadata.Extension" in runtime_diagnostics_test_source and "Info.plist nested scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested blank string metadata fixture: missing" in runtime_diagnostics_test_source,
            "runtime diagnostics test should cover application path, bundle identifier, and typed Info.plist metadata comparisons",
            failures)
    require("read_plist_string_value" in runtime_diagnostics_source and "if isinstance(value, str) and value.strip():" in runtime_diagnostics_source and "trimmed_value = value" in runtime_diagnostics_source and "Info.plist scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist blank string metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested blank string metadata fixture: missing" in runtime_diagnostics_test_source and "test_validator_rejects_missing_runtime_diagnostics_info_plist_string_guard" in validate_project_test_source and "test_validator_rejects_missing_runtime_diagnostics_blank_info_plist_guard" in validate_project_test_source,
    ...
    require(validate_project_test_path.exists() and validate_project_test_path.stat().st_mode & 0o111,
            ...
            failures)
    require("sys.dont_write_bytecode = True" in validate_project_test_source and "malformed mdhd" in validate_project_test_source and "test_unsupported_mdhd_version_does_not_report_duration" in validate_project_test_source and "test_unsupported_hdlr_version_does_not_report_duration" in validate_project_test_source and "test_unsupported_stts_version_does_not_report_frame_rate" in validate_project_test_source and "test_unsupported_stsd_version_does_not_report_dimensions" in validate_project_test_source and "test_non_video_track_stsd_does_not_report_dimensions" in validate_project_test_source and "mp4_video_metadata" in validate_project_test_source and "assert_validator_rejects_mutation" in validate_project_test_source and "test_validator_rejects_missing_indefinite_stream_duration_guard" in validate_project_test_source and "test_validator_rejects_missing_non_finite_stream_duration_guard" in validate_project_test_source and "test_validator_rejects_missing_non_finite_sample_time_guard" in validate_project_test_source and "test_validator_rejects_missing_host_time_sample_retiming" in validate_project_test_source and "test_validator_rejects_missing_unknown_signature_state" in validate_project_test_source and "test_validator_rejects_missing_all_architecture_signature_validation" in validate_project_test_source and "test_validator_rejects_missing_signing_information_unknown_guard" in validate_project_test_source and "test_validator_rejects_missing_host_team_identifier_shape_guard" in validate_project_test_source and "test_validator_rejects_numeric_boolean_entitlement_acceptance" in validate_project_test_source and "test_validator_rejects_missing_runtime_diagnostics_untrimmed_app_group_guard" in validate_project_test_source and "test_validator_rejects_missing_runtime_diagnostics_fallback_untrimmed_app_group_guard" in validate_project_test_source and "test_validator_rejects_loose_team_id_prefix_lengths" in validate_project_test_source and "test_validator_rejects_bare_application_group_acceptance" in validate_project_test_source and "test_validator_rejects_missing_extension_load_failure_detail_row" in validate_project_test_source and "test_validator_rejects_missing_host_mp4_mdhd_version_guard" in validate_project_test_source and "test_validator_rejects_missing_host_mp4_full_box_version_guards" in validate_project_test_source and "test_validator_rejects_missing_host_mp4_video_track_dimension_gate" in validate_project_test_source and "test_validator_rejects_missing_host_mp4_sample_count_guard" in validate_project_test_source and "test_validator_rejects_broad_appintents_log_ignore" in validate_project_test_source and "test_validator_rejects_missing_partial_ci_log_scan" in validate_project_test_source and "test_validator_rejects_missing_build_product_python_resolver" in validate_project_test_source and "test_validator_rejects_missing_build_product_configuration_guard" in validate_project_test_source and "test_validator_rejects_missing_packaged_file_byte_count_verifier" in validate_project_test_source,
            ...
            failures)
    require("test_validator_rejects_missing_build_product_info_plist_string_type_guard" in validate_project_test_source and "test_validator_rejects_missing_build_product_blank_info_plist_guard" in validate_project_test_source and "test_validator_rejects_missing_build_product_blank_cmio_guard" in validate_project_test_source,
            "validate_project unit tests should cover build-product Info.plist string type and blank-string guard mutation rejection",
            failures)
    ...
    if workflow_path.exists():
        ...
        require("-target \"$TARGET_NAME\"" in build_unsigned_source,
                ...
                failures)
        require('BUILD_ARCH="${BUILD_ARCH:-}"' in build_unsigned_source and 'BUILD_ARCH="$(/usr/bin/uname -m)"' in build_unsigned_source and "ARCHS=\"$BUILD_ARCH\"" in build_unsigned_source,
