...
"""
    ...
    require("test_ignores_appintents_metadata_notice" in build_log_scanner_test_source and "test_fails_on_actionable_warning" in build_log_scanner_test_source and "test_fails_on_other_appintents_warning" in build_log_scanner_test_source and "test_fails_on_nonzero_command_failure" in build_log_scanner_test_source and "test_fails_on_build_commands_failed_summary" in build_log_scanner_test_source and "test_fails_on_build_failed_banner" in build_log_scanner_test_source and "test_fails_on_testing_failed_summary" in build_log_scanner_test_source and "test_fails_on_test_failed_banner" in build_log_scanner_test_source and "test_scans_multiple_build_logs" in build_log_scanner_test_source and "test_fails_on_missing_build_log" in build_log_scanner_test_source and "test_fails_on_directory_build_log" in build_log_scanner_test_source and "test_requires_build_log_argument" in build_log_scanner_test_source and "Build log not found:" in build_log_scanner_test_source and "Build log is not a regular file:" in build_log_scanner_test_source and "Usage: scan_build_log.py BUILD_LOG [BUILD_LOG ...]" in build_log_scanner_test_source and ":2: SwiftCompile warning: real source warning" in build_log_scanner_test_source,
            ...
            failures)
    require("xcodebuild" in build_unsigned_source and "command -v xcodebuild" in build_unsigned_source and "xcodebuild is required to build GarethVideoCam" in build_unsigned_source and "exit 127" in build_unsigned_source and "-target \"$TARGET_NAME\"" in build_unsigned_source and "CODE_SIGNING_ALLOWED=NO" in build_unsigned_source and "CODE_SIGNING_REQUIRED=NO" in build_unsigned_source and "BUILD_ARCH" in build_unsigned_source and "RUNNER_ARCH" not in build_unsigned_source and "BUILD_OUTPUT_PATH" in build_unsigned_source and "SYMROOT=\"$BUILD_OUTPUT_PATH/Products\"" in build_unsigned_source and "OBJROOT=\"$BUILD_OUTPUT_PATH/Intermediates\"" in build_unsigned_source and "-derivedDataPath" not in build_unsigned_source and "configurations=(Debug Release)" in build_unsigned_source and "build-${configuration}.log" in build_unsigned_source and "validate_configuration_name" in build_unsigned_source and "validate_configuration_name \"$configuration\"" in build_unsigned_source and "Invalid Xcode configuration name:" in build_unsigned_source and build_unsigned_source.index('validate_configuration_name "$configuration"') < build_unsigned_source.index("command -v xcodebuild"),
