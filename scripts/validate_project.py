...
def main():
    ...
    require("case evidence" in host_source and "RuntimeEvidencePanel(manager: manager)" in host_source and "private struct RuntimeEvidencePanel" in host_source and "struct RuntimeEvidenceCheck" in host_source and "runtimeEvidenceChecks" in host_source and "runtimeEvidenceExpectedDiagnostics" in host_source and "Runtime Evidence" in host_source and "Diagnostics Command" in host_source and "ForEach(Array(manager.runtimeEvidenceChecks.enumerated()), id: \\.element.id)" in host_source,
            ...
            failures)
    require("Bundled video metadata ready" in host_source and 'RuntimeEvidenceCheck(id: "video-metadata"' in host_source,
            "host app runtime evidence should include bundled-video metadata readiness",
            failures)
    ...
    require("CI-equivalent unsigned compile" in readme_text and "./scripts/build_unsigned.sh" in readme_text and "./scripts/scan_build_log.py build-Debug.log build-Release.log" in readme_text and ".build/Xcode" in readme_text and "BUILD_OUTPUT_PATH" in readme_text,
            ...
            failures)
    require("verifies the built app products contain the embedded system extension, aligned bundle versions, declared executables, display metadata, privacy usage strings, resolved CoreMediaIO extension metadata, and bundled video" in readme_text,
    ...
    require("GARETH_DIAGNOSTICS_SELF_TEST=readiness-rollup" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=readiness-rollup-unknown" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=readiness-rollup-ready" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=bundle-version-match" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=mach-service" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=application-group" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=camera-device" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=registration" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=activation-evidence" in runtime_diagnostics_test_source and "Runtime readiness result: blocked" in runtime_diagnostics_test_source and "Runtime readiness result: incomplete" in runtime_diagnostics_test_source and "Runtime readiness result: ready" in runtime_diagnostics_test_source and "Runtime readiness checks ready: 1/3" in runtime_diagnostics_test_source and "Runtime readiness checks ready: 1/2" in runtime_diagnostics_test_source and "Runtime readiness checks ready: 1/1" in runtime_diagnostics_test_source and "Runtime readiness next action: resolve Blocked fixture" in runtime_diagnostics_test_source and "Runtime readiness next action: inspect Unknown fixture" in runtime_diagnostics_test_source and "Runtime readiness next action: submit the system extension request" in runtime_diagnostics_test_source and "Bundle version match fixture: yes" in runtime_diagnostics_test_source and "Bundle version short mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle version build mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle version missing fixture: no" in runtime_diagnostics_test_source and "Mach service direct fixture ready: yes" in runtime_diagnostics_test_source and "Mach service team-prefixed fixture ready: yes" in runtime_diagnostics_test_source and "Mach service unresolved fixture resolved: no" in runtime_diagnostics_test_source and "Mach service wrong fixture matches expected: no" in runtime_diagnostics_test_source and "Application group shared fixture ready: yes" in runtime_diagnostics_test_source and "Application group mismatched fixture ready: no" in runtime_diagnostics_test_source and "Application group unresolved fixture ready: no" in runtime_diagnostics_test_source and "Camera device present fixture: yes" in runtime_diagnostics_test_source and "Camera device missing fixture: no" in runtime_diagnostics_test_source and "Camera device empty fixture: unknown" in runtime_diagnostics_test_source and "Registration active fixture activated enabled: yes" in runtime_diagnostics_test_source and "Registration waiting fixture activated enabled: no" in runtime_diagnostics_test_source and "Registration empty fixture present: unknown" in runtime_diagnostics_test_source and "Runtime activation evidence result: active" in runtime_diagnostics_test_source and "Runtime activation evidence result: blocked" in runtime_diagnostics_test_source and "Runtime activation evidence result: incomplete" in runtime_diagnostics_test_source and "Runtime activation evidence next action: resolve Extension registration entry present" in runtime_diagnostics_test_source and "Runtime activation evidence next action: inspect Extension registration activated enabled" in runtime_diagnostics_test_source and "Runtime diagnostics tests passed." in runtime_diagnostics_test_source,
            ...
            failures)
    require("GARETH_DIAGNOSTICS_SELF_TEST=video-metadata" in runtime_diagnostics_test_source and "Video metadata ready fixture: yes" in runtime_diagnostics_test_source and "Video metadata wrong width fixture: no" in runtime_diagnostics_test_source and "Video metadata missing duration fixture: unknown" in runtime_diagnostics_test_source and "Video metadata zero duration fixture: no" in runtime_diagnostics_test_source,
    ...
    require("codesign -d --entitlements :-" in runtime_diagnostics_source and "spctl --assess" in runtime_diagnostics_source and "systemextensionsctl list" in runtime_diagnostics_source and "registration_output" in runtime_diagnostics_source and "extension_registration_entries" in runtime_diagnostics_source and "extension_registration_present_value" in runtime_diagnostics_source and "extension_registration_activated_enabled_value" in runtime_diagnostics_source and "Extension registration entry present" in runtime_diagnostics_source and "Extension registration activated enabled" in runtime_diagnostics_source and "Matching system extension registration entries:" in runtime_diagnostics_source and "Full systemextensionsctl list output:" in runtime_diagnostics_source and "grep -F \"$extension_identifier\"" in runtime_diagnostics_source and "Camera Devices" in runtime_diagnostics_source and "SPCameraDataType" in runtime_diagnostics_source and "EXPECTED_CAMERA_NAME" in runtime_diagnostics_source and "camera_device_present_value" in runtime_diagnostics_source and "Expected virtual camera device:" in runtime_diagnostics_source and "Expected virtual camera device present" in runtime_diagnostics_source and "Full system_profiler SPCameraDataType output:" in runtime_diagnostics_source and "Runtime Activation Evidence" in runtime_diagnostics_source and "print_activation_evidence_summary" in runtime_diagnostics_source and "Runtime activation evidence result:" in runtime_diagnostics_source and "Runtime activation evidence checks ready:" in runtime_diagnostics_source and "Runtime activation evidence next action:" in runtime_diagnostics_source and "Running App and Extension Processes" in runtime_diagnostics_source and "/bin/ps -axo" in runtime_diagnostics_source and "script_pid=\"$$\"" in runtime_diagnostics_source and "collect_runtime_diagnostics.sh" in runtime_diagnostics_source and "$4 ~ /(^|\\/)awk$/" in runtime_diagnostics_source and "Bundle short version:" in runtime_diagnostics_source and "Bundle build version:" in runtime_diagnostics_source and "read_info_plist_value" in runtime_diagnostics_source and "read_extension_mach_service_name" in runtime_diagnostics_source and "contains_unresolved_build_setting" in runtime_diagnostics_source and "mach_service_resolved_value" in runtime_diagnostics_source and "mach_service_matches_expected_value" in runtime_diagnostics_source and "mach_service_readiness_value" in runtime_diagnostics_source and "EXTENSION_INFO_PLIST" in runtime_diagnostics_source and "bundle_versions_match_readiness_value" in runtime_diagnostics_source and "APP_GROUP_ENTITLEMENT" in runtime_diagnostics_source and "APP_GROUP_BASE_ID" in runtime_diagnostics_source and "read_application_groups" in runtime_diagnostics_source and "application_groups_ready_value" in runtime_diagnostics_source and "Application group match ready" in runtime_diagnostics_source and "Application groups share expected value:" in runtime_diagnostics_source and "App application groups:" in runtime_diagnostics_source and "Extension application groups:" in runtime_diagnostics_source and "Expected application group suffix:" in runtime_diagnostics_source and "Bundle Version Match" in runtime_diagnostics_source and "App bundle short version:" in runtime_diagnostics_source and "App bundle build version:" in runtime_diagnostics_source and "Extension bundle short version:" in runtime_diagnostics_source and "Extension bundle build version:" in runtime_diagnostics_source and "Bundle short versions match:" in runtime_diagnostics_source and "Bundle build versions match:" in runtime_diagnostics_source and "Bundle versions match ready" in runtime_diagnostics_source and "Application Runtime Metadata" in runtime_diagnostics_source and "App CFBundleExecutable:" in runtime_diagnostics_source and "App executable path:" in runtime_diagnostics_source and "App executable exists:" in runtime_diagnostics_source and "App executable is executable:" in runtime_diagnostics_source and "App executable ready" in runtime_diagnostics_source and "Embedded Extension Runtime Metadata" in runtime_diagnostics_source and "Extension CFBundleExecutable:" in runtime_diagnostics_source and "Extension executable path:" in runtime_diagnostics_source and "Extension executable exists:" in runtime_diagnostics_source and "Extension executable is executable:" in runtime_diagnostics_source and "Extension CMIO Mach service:" in runtime_diagnostics_source and "Extension CMIO Mach service resolved:" in runtime_diagnostics_source and "Extension CMIO Mach service matches expected identifier:" in runtime_diagnostics_source and "Extension executable ready" in runtime_diagnostics_source and "Extension CMIO Mach service ready" in runtime_diagnostics_source and "print_readiness_check" in runtime_diagnostics_source and "print_readiness_rollup" in runtime_diagnostics_source and "Runtime readiness result:" in runtime_diagnostics_source and "Runtime readiness checks ready:" in runtime_diagnostics_source and "Runtime readiness checks blocked:" in runtime_diagnostics_source and "Runtime readiness checks unknown:" in runtime_diagnostics_source and "Runtime readiness next action:" in runtime_diagnostics_source and "readiness_first_blocked_label" in runtime_diagnostics_source and "readiness_first_unknown_label" in runtime_diagnostics_source and "readiness_ready_count" in runtime_diagnostics_source and "readiness_blocked_count" in runtime_diagnostics_source and "readiness_unknown_count" in runtime_diagnostics_source and "Contents/Info.plist" in runtime_diagnostics_source and "PlistBuddy -c \"Print :${key}\"" in runtime_diagnostics_source and "Print :CMIOExtension:CMIOExtensionMachServiceName" in runtime_diagnostics_source and "plutil -extract \"$key\" raw" in runtime_diagnostics_source and "plutil -extract CMIOExtension.CMIOExtensionMachServiceName raw" in runtime_diagnostics_source and "CFBundleShortVersionString" in runtime_diagnostics_source and "CFBundleVersion" in runtime_diagnostics_source and "LOG_WINDOW" in runtime_diagnostics_source and "Bundled Video" in runtime_diagnostics_source and "VIDEO_PATH" in runtime_diagnostics_source and "Video resource exists:" in runtime_diagnostics_source and "Video byte size:" in runtime_diagnostics_source and "Video resource is empty:" in runtime_diagnostics_source and "Video SHA-256:" in runtime_diagnostics_source and "print_file_sha256" in runtime_diagnostics_source and "kMDItemPixelWidth" in runtime_diagnostics_source and "kMDItemPixelHeight" in runtime_diagnostics_source and "kMDItemDurationSeconds" in runtime_diagnostics_source and "Application Location Check" in runtime_diagnostics_source and "EXPECTED_APP_PATH" in runtime_diagnostics_source and "App path is inside /Applications:" in runtime_diagnostics_source and "App path matches expected app path:" in runtime_diagnostics_source and "Quarantine Check" in runtime_diagnostics_source and "print_quarantine_status" in runtime_diagnostics_source and "com.apple.quarantine" in runtime_diagnostics_source and "Bundle Identifier Check" in runtime_diagnostics_source and "read_bundle_identifier" in runtime_diagnostics_source and "App bundle identifier matches:" in runtime_diagnostics_source and "Extension bundle identifier matches:" in runtime_diagnostics_source and "Signing Team Match" in runtime_diagnostics_source and "read_team_identifier" in runtime_diagnostics_source and "Team identifiers match:" in runtime_diagnostics_source and "Entitlement Check" in runtime_diagnostics_source and "HOST_SYSTEM_EXTENSION_ENTITLEMENT" in runtime_diagnostics_source and "has_boolean_entitlement" in runtime_diagnostics_source and "App System Extension entitlement present:" in runtime_diagnostics_source and "Extension carries host-only System Extension entitlement:" in runtime_diagnostics_source and "Runtime Readiness Summary" in runtime_diagnostics_source and "print_yes_no_unknown" in runtime_diagnostics_source and 'if [ "$APP_PATH" = "$EXPECTED_APP_PATH" ]; then' in runtime_diagnostics_source and "Application location ready" in runtime_diagnostics_source and "App bundle identifier ready" in runtime_diagnostics_source and "App signature ready" in runtime_diagnostics_source and "App System Extension entitlement ready" in runtime_diagnostics_source and "Extension bundle identifier ready" in runtime_diagnostics_source and "Extension signature ready" in runtime_diagnostics_source and "Extension host-only entitlement absent" in runtime_diagnostics_source and "Signing Team match ready" in runtime_diagnostics_source and "Bundled video ready" in runtime_diagnostics_source and "systemextensionsd" in runtime_diagnostics_source and "com.apple.CoreMediaIO" in runtime_diagnostics_source,
            ...
            failures)
    require("EXPECTED_VIDEO_WIDTH" in runtime_diagnostics_source and "EXPECTED_VIDEO_HEIGHT" in runtime_diagnostics_source and "mdls_metadata_value" in runtime_diagnostics_source and "metadata_number_matches_expected_value" in runtime_diagnostics_source and "metadata_positive_number_value" in runtime_diagnostics_source and "video_metadata_readiness_value" in runtime_diagnostics_source and "Expected video pixel width:" in runtime_diagnostics_source and "Video pixel width ready" in runtime_diagnostics_source and "Video pixel height ready" in runtime_diagnostics_source and "Video duration ready" in runtime_diagnostics_source and "Bundled video metadata ready" in runtime_diagnostics_source,
            "runtime diagnostics script should report bundled-video metadata readiness for expected dimensions and positive duration",
            failures)
