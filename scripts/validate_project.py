...
def main():
    ...
    require(verify_build_products_path.stat().st_mode & 0o111,
            ...
            failures)
    require("write_product_fixture" in verify_build_products_test_source and "write_executable_fixture" in verify_build_products_test_source and "remove_info_plist_key" in verify_build_products_test_source and "set_info_plist_key" in verify_build_products_test_source and "cp \"$ROOT/Extension/video.mp4\"" in verify_build_products_test_source and "com.example.WrongExtension" in verify_build_products_test_source and "Unexpected Debug extension bundle identifier" in verify_build_products_test_source and "Unexpected Debug app CFBundleDisplayName" in verify_build_products_test_source and "Missing Debug app NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Missing or empty Debug bundled video resource" in verify_build_products_test_source and "Missing Debug bundled video dimensions" in verify_build_products_test_source and "unparsable bundled video metadata" in verify_build_products_test_source and "Missing or non-executable Debug extension executable" in verify_build_products_test_source and "Missing Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "Unresolved Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "Unexpected Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "com.example.WrongMachService" in verify_build_products_test_source and "com.example.$EXTENSION_ID" in verify_build_products_test_source and "dotted-prefix CMIO extension metadata" in verify_build_products_test_source and "Mismatched Debug bundle short versions" in verify_build_products_test_source and "Mismatched Debug bundle build versions" in verify_build_products_test_source and "Build-product verifier tests passed." in verify_build_products_test_source,
