...
"""
    ...
    require("CI-equivalent unsigned compile" in readme_text and "./scripts/build_unsigned.sh" in readme_text and "./scripts/scan_build_log.py .build/Xcode/Logs/build-Debug.log .build/Xcode/Logs/build-Release.log" in readme_text and ".build/Xcode" in readme_text and ".build/Xcode/Logs" in readme_text and "BUILD_OUTPUT_PATH" in readme_text and "BUILD_LOG_PATH" in readme_text,
            ...
            failures)
    require("runs `make check`, performs unsigned Debug and Release target builds" in readme_text and "verifies the built app products contain the embedded system extension, aligned bundle versions, declared executables, display metadata, product-specific privacy usage strings, bundled runtime diagnostics self-tests, resolved CoreMediaIO extension metadata, and bundled-video metadata" in readme_text and "captures the Xcode logs under `.build/Xcode/Logs`" in readme_text and "scans any captured `build-*.log` output including partial logs from failed builds" in readme_text and "build-failed, archive-failed, analyze-failed, clean-failed, and test-failed banners" in readme_text,
    ...
    require("test_ignores_appintents_metadata_notice" in build_log_scanner_test_source and "test_fails_on_actionable_warning" in build_log_scanner_test_source and "test_fails_on_other_appintents_warning" in build_log_scanner_test_source and "test_fails_on_appintents_error_notice" in build_log_scanner_test_source and "test_fails_on_nonzero_command_failure" in build_log_scanner_test_source and "test_fails_on_build_commands_failed_summary" in build_log_scanner_test_source and "test_fails_on_build_failed_banner" in build_log_scanner_test_source and "test_fails_on_archive_failed_banner" in build_log_scanner_test_source and "test_fails_on_analyze_failed_banner" in build_log_scanner_test_source and "test_fails_on_clean_failed_banner" in build_log_scanner_test_source and "ARCHIVE FAILED" in build_log_scanner_source and "ANALYZE FAILED" in build_log_scanner_source and "CLEAN FAILED" in build_log_scanner_source and "test_fails_on_testing_failed_summary" in build_log_scanner_test_source and "test_fails_on_test_failed_banner" in build_log_scanner_test_source and "test_scans_multiple_build_logs" in build_log_scanner_test_source and "test_fails_on_missing_build_log" in build_log_scanner_test_source and "test_fails_on_directory_build_log" in build_log_scanner_test_source and "test_fails_on_unreadable_build_log" in build_log_scanner_test_source and "test_requires_build_log_argument" in build_log_scanner_test_source and "Build log not found:" in build_log_scanner_test_source and "Build log is not a regular file:" in build_log_scanner_test_source and "Build log is not readable:" in build_log_scanner_test_source and "Usage: scan_build_log.py BUILD_LOG [BUILD_LOG ...]" in build_log_scanner_test_source and ":2: SwiftCompile warning: real source warning" in build_log_scanner_test_source,
            "build-log scanner should have regression coverage for ignored warnings, actionable warnings, build/test command failure summaries, build/archive/analyze/clean/test-failed banners, unreadable and missing build logs, and missing CLI arguments",
            failures)
    ...
    require("APP_CAMERA_USAGE_DESCRIPTION" in verify_build_products_source and "APP_SYSTEM_EXTENSION_USAGE_DESCRIPTION" in verify_build_products_source and "EXTENSION_CAMERA_USAGE_DESCRIPTION" in verify_build_products_source and "EXTENSION_SYSTEM_EXTENSION_USAGE_DESCRIPTION" in verify_build_products_source and "verify_info_plist_value \"$configuration\" \"app\" \"$app_path\" \"NSCameraUsageDescription\"" in verify_build_products_source and "verify_info_plist_value \"$configuration\" \"extension\" \"$extension_path\" \"NSCameraUsageDescription\"" in verify_build_products_source,
            ...
            failures)
    require("if isinstance(value, str):" in verify_build_products_source and "trimmed_value = value.strip()" in verify_build_products_source and "if trimmed_value and trimmed_value == value:" in verify_build_products_source and "set_info_plist_boolean_key" in verify_build_products_test_source and "non-string app display name" in verify_build_products_test_source and "blank app display name" in verify_build_products_test_source and "untrimmed app display name" in verify_build_products_test_source and "test_validator_rejects_missing_build_product_blank_info_plist_guard" in validate_project_test_source and "test_validator_rejects_missing_build_product_untrimmed_info_plist_guard" in validate_project_test_source,
            "build-product verifier should reject non-string, blank, or untrimmed Info.plist display and privacy strings",
            failures)
    require("if isinstance(mach_service_name, str):" in verify_build_products_source and "trimmed_mach_service_name = mach_service_name.strip()" in verify_build_products_source and "if trimmed_mach_service_name and trimmed_mach_service_name == mach_service_name:" in verify_build_products_source and "non-string CMIO extension metadata" in verify_build_products_test_source and "blank CMIO extension metadata" in verify_build_products_test_source and "untrimmed CMIO extension metadata" in verify_build_products_test_source and "test_validator_rejects_missing_build_product_blank_cmio_guard" in validate_project_test_source and "test_validator_rejects_missing_build_product_cmio_string_type_guard" in validate_project_test_source and "test_validator_rejects_missing_build_product_untrimmed_cmio_guard" in validate_project_test_source,
    ...
    require("write_product_fixture" in verify_build_products_test_source and "write_executable_fixture" in verify_build_products_test_source and "remove_info_plist_key" in verify_build_products_test_source and "set_info_plist_key" in verify_build_products_test_source and "cp \"$ROOT/scripts/collect_runtime_diagnostics.sh\"" in verify_build_products_test_source and "cp \"$ROOT/scripts/validate_project.py\"" in verify_build_products_test_source and "cp \"$ROOT/Extension/video.mp4\"" in verify_build_products_test_source and "Missing Debug app product" in verify_build_products_test_source and "Missing Debug embedded system extension" in verify_build_products_test_source and "com.example.WrongExtension" in verify_build_products_test_source and "Unexpected Debug extension bundle identifier" in verify_build_products_test_source and "Missing Debug app CFBundleDisplayName" in verify_build_products_test_source and "blank app display name" in verify_build_products_test_source and "untrimmed app display name" in verify_build_products_test_source and "Missing Debug extension CFBundleDisplayName" in verify_build_products_test_source and "Unexpected Debug app CFBundleDisplayName" in verify_build_products_test_source and "Unexpected Debug extension CFBundleDisplayName" in verify_build_products_test_source and "Missing Debug app NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Missing Debug extension NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Missing Debug app NSCameraUsageDescription" in verify_build_products_test_source and "Missing Debug extension NSCameraUsageDescription" in verify_build_products_test_source and "Unexpected Debug app NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Unexpected Debug extension NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Unexpected Debug app NSCameraUsageDescription" in verify_build_products_test_source and "Unexpected Debug extension NSCameraUsageDescription" in verify_build_products_test_source and "Missing Debug app runtime diagnostics script" in verify_build_products_test_source and "Missing Debug app runtime diagnostics parser" in verify_build_products_test_source and "Missing or empty Debug bundled video resource" in verify_build_products_test_source and "Missing Debug bundled video dimensions" in verify_build_products_test_source and "unparsable bundled video metadata" in verify_build_products_test_source and "Missing or non-executable Debug app executable" in verify_build_products_test_source and "non-executable app binary" in verify_build_products_test_source and "Missing or non-executable Debug extension executable" in verify_build_products_test_source and "non-executable extension binary" in verify_build_products_test_source and "Missing Debug app CFBundleExecutable" in verify_build_products_test_source and "missing app executable declaration" in verify_build_products_test_source and "Missing Debug extension CFBundleExecutable" in verify_build_products_test_source and "missing extension executable declaration" in verify_build_products_test_source and "Missing Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "blank CMIO extension metadata" in verify_build_products_test_source and "untrimmed CMIO extension metadata" in verify_build_products_test_source and "Unresolved Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "Unexpected Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "com.example.WrongMachService" in verify_build_products_test_source and "com.example.$EXTENSION_ID" in verify_build_products_test_source and "dotted-prefix CMIO extension metadata" in verify_build_products_test_source and "Mismatched Debug bundle short versions" in verify_build_products_test_source and "Mismatched Debug bundle build versions" in verify_build_products_test_source and "Build-product verifier tests passed." in verify_build_products_test_source,
            ...
            failures)
    require("duplicate embedded system extension" in verify_build_products_test_source and "Unexpected Debug embedded system extension count: 2" in verify_build_products_test_source,
    ...
    require("GARETH_DIAGNOSTICS_SELF_TEST=executable-readiness" in runtime_diagnostics_test_source and "Executable missing name fixture: no" in runtime_diagnostics_test_source and "Executable missing file fixture: no" in runtime_diagnostics_test_source and "Executable non-executable fixture: no" in runtime_diagnostics_test_source and "Executable ready fixture: yes" in runtime_diagnostics_test_source,
            ...
            failures)
    require("GARETH_DIAGNOSTICS_SELF_TEST=application-identity" in runtime_diagnostics_test_source and "App path match fixture: yes" in runtime_diagnostics_test_source and "App path mismatch fixture: no" in runtime_diagnostics_test_source and "Application location existing fixture: yes" in runtime_diagnostics_test_source and "Application location missing fixture: no" in runtime_diagnostics_test_source and "Application location mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle identifier match fixture: yes" in runtime_diagnostics_test_source and "Bundle identifier mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle identifier missing fixture: no" in runtime_diagnostics_test_source and "Info.plist string metadata fixture: com.example.StringMetadata" in runtime_diagnostics_test_source and "Info.plist scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist blank string metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist untrimmed string metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested string metadata fixture: com.example.StringMetadata.Extension" in runtime_diagnostics_test_source and "Info.plist nested scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested blank string metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested untrimmed string metadata fixture: missing" in runtime_diagnostics_test_source,
            "runtime diagnostics test should cover application path, bundle identifier, and typed Info.plist metadata comparisons",
            failures)
    require("read_plist_string_value" in runtime_diagnostics_source and "if isinstance(value, str):" in runtime_diagnostics_source and "trimmed_value = value.strip()" in runtime_diagnostics_source and "if trimmed_value and trimmed_value == value:" in runtime_diagnostics_source and "trimmed_value = value" in runtime_diagnostics_source and "if (trimmed_value != value)" in runtime_diagnostics_source and "Info.plist scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist blank string metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist untrimmed string metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested scalar metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested blank string metadata fixture: missing" in runtime_diagnostics_test_source and "Info.plist nested untrimmed string metadata fixture: missing" in runtime_diagnostics_test_source and "test_validator_rejects_missing_runtime_diagnostics_info_plist_string_guard" in validate_project_test_source and "test_validator_rejects_missing_runtime_diagnostics_blank_info_plist_guard" in validate_project_test_source and "test_validator_rejects_missing_runtime_diagnostics_untrimmed_info_plist_guard" in validate_project_test_source,
