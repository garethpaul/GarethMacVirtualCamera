...
"""
    ...
    require('if [ "$application_group" = "$APP_GROUP_BASE_ID" ]; then' not in runtime_diagnostics_source and "Application group direct fixture ready: no" in runtime_diagnostics_test_source,
            ...
            failures)
    require("Application group empty format fixture: none" in runtime_diagnostics_test_source and "Application group list format fixture: ABCDE12345.com.garethpaul.GarethVideoCam, ZYXWV98765.com.garethpaul.GarethVideoCam" in runtime_diagnostics_test_source and "Application group malformed entitlements readable fixture: no" in runtime_diagnostics_test_source and "Application group scalar entitlements readable fixture: no" in runtime_diagnostics_test_source and "Application group fallback malformed entitlements readable fixture: no" in runtime_diagnostics_test_source and "format_application_groups" in runtime_diagnostics_source and "formatted_groups" in runtime_diagnostics_source and "malformed_entitlements_status" in runtime_diagnostics_source and "GARETH_DIAGNOSTICS_SKIP_PYTHON" in runtime_diagnostics_source and "plutil -lint" in runtime_diagnostics_source and "not isinstance(groups, list)" in runtime_diagnostics_source and 'if ! read_application_groups_from_entitlements_file "$entitlements_file" >"$groups_file" 2>/dev/null; then' in runtime_diagnostics_source,
            "runtime diagnostics test should cover empty and multi-value app-group formatting",
            failures)
    require("Application group fallback scalar entitlements readable fixture: no" in runtime_diagnostics_test_source and "plistbuddy_output" in runtime_diagnostics_source and "saw_array = 1" in runtime_diagnostics_source and "if (!saw_array)" in runtime_diagnostics_source,
    ...
    require("codesign -dv" not in runtime_diagnostics_source and runtime_diagnostics_source.count("codesign -d --all-architectures -v") >= 3,
            ...
            failures)
    require("boolean_entitlement_value" in runtime_diagnostics_source and "read_boolean_entitlement_from_entitlements_file" in runtime_diagnostics_source and "plutil -lint" in runtime_diagnostics_source and "unknown; signed entitlements could not be read." in runtime_diagnostics_source and "extension_host_only_entitlement_absent_readiness_value" in runtime_diagnostics_source and "run_extension_host_entitlement_self_test" in runtime_diagnostics_source and "extension-host-entitlement" in runtime_diagnostics_source and "Extension host-only entitlement absent\" \"$(extension_host_only_entitlement_absent_readiness_value" in runtime_diagnostics_source,
