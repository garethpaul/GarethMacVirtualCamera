...
def main():
    ...
    require("didOpenSettings" in host_source and "System Settings Unavailable" in host_source,
            ...
            failures)
    require("./scripts/check_project.sh" in readme_text and "project metadata validation, build-log scanner tests, runtime diagnostics tests, build-product verifier tests, shell syntax checks, and whitespace checks" in readme_text and "bundle identifiers, aligned bundle versions, declared executables, privacy usage strings, resolved CoreMediaIO extension metadata, and the bundled video resource" in readme_text,
    ...
    require("CI-equivalent unsigned compile" in readme_text and "./scripts/build_unsigned.sh" in readme_text and "./scripts/scan_build_log.py build-Debug.log build-Release.log" in readme_text and ".build/Xcode" in readme_text and "BUILD_OUTPUT_PATH" in readme_text,
            ...
            failures)
    require("verifies the built app products contain the embedded system extension, aligned bundle versions, declared executables, privacy usage strings, resolved CoreMediaIO extension metadata, and bundled video" in readme_text,
    ...
    require("GarethVideoCam.app" in verify_build_products_source and "com.garethpaul.GarethVideoCam.Extension.systemextension" in verify_build_products_source and "Contents/Library/SystemExtensions" in verify_build_products_source and "Contents/Resources/video.mp4" in verify_build_products_source and "read_bundle_identifier" in verify_build_products_source and "read_bundle_short_version" in verify_build_products_source and "read_bundle_build_version" in verify_build_products_source and "verify_aligned_bundle_versions" in verify_build_products_source and "Mismatched %s bundle short versions" in verify_build_products_source and "Mismatched %s bundle build versions" in verify_build_products_source and "read_bundle_executable" in verify_build_products_source and "verify_bundle_executable" in verify_build_products_source and "verify_info_plist_string" in verify_build_products_source and "NSCameraUsageDescription" in verify_build_products_source and "NSSystemExtensionUsageDescription" in verify_build_products_source and "read_extension_mach_service_name" in verify_build_products_source and "verify_extension_cmio_metadata" in verify_build_products_source and "CMIOExtensionMachServiceName" in verify_build_products_source and "Unresolved %s extension CMIOExtensionMachServiceName" in verify_build_products_source and "Unexpected %s extension CMIOExtensionMachServiceName" in verify_build_products_source and "*\".$EXTENSION_ID\"" in verify_build_products_source and "Contents/Info.plist" in verify_build_products_source and "Contents/MacOS" in verify_build_products_source and "CFBundleExecutable" in verify_build_products_source and "CFBundleShortVersionString" in verify_build_products_source and "CFBundleVersion" in verify_build_products_source and "plistlib" in verify_build_products_source and "PlistBuddy" not in verify_build_products_source and "Debug Release" in verify_build_products_source,
            "build-product verifier should check app, embedded extension, bundle identifiers, aligned bundle versions, declared executables, privacy usage strings, resolved CoreMediaIO metadata, and bundled video",
            failures)
    require(verify_build_products_path.stat().st_mode & 0o111,
            "build-product verifier script should be executable",
            failures)
    require("write_product_fixture" in verify_build_products_test_source and "write_executable_fixture" in verify_build_products_test_source and "remove_info_plist_key" in verify_build_products_test_source and "com.example.WrongExtension" in verify_build_products_test_source and "Unexpected Debug extension bundle identifier" in verify_build_products_test_source and "Missing Debug app NSSystemExtensionUsageDescription" in verify_build_products_test_source and "Missing or empty Debug bundled video resource" in verify_build_products_test_source and "Missing or non-executable Debug extension executable" in verify_build_products_test_source and "Missing Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "Unresolved Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "Unexpected Debug extension CMIOExtensionMachServiceName" in verify_build_products_test_source and "com.example.WrongMachService" in verify_build_products_test_source and "Mismatched Debug bundle short versions" in verify_build_products_test_source and "Mismatched Debug bundle build versions" in verify_build_products_test_source and "Build-product verifier tests passed." in verify_build_products_test_source,
            "build-product verifier should have fixture coverage for passing products, bundle identifier failures, version mismatches, missing executables, missing privacy usage strings, missing/unresolved/unexpected CoreMediaIO metadata, and missing bundled video",
            failures)
    require(verify_build_products_test_path.stat().st_mode & 0o111,
            "build-product verifier test script should be executable",
            failures)
    require("GARETH_DIAGNOSTICS_SELF_TEST=readiness-rollup" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=readiness-rollup-unknown" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=readiness-rollup-ready" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=bundle-version-match" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=mach-service" in runtime_diagnostics_test_source and "GARETH_DIAGNOSTICS_SELF_TEST=application-group" in runtime_diagnostics_test_source and "Runtime readiness result: blocked" in runtime_diagnostics_test_source and "Runtime readiness result: incomplete" in runtime_diagnostics_test_source and "Runtime readiness result: ready" in runtime_diagnostics_test_source and "Runtime readiness checks ready: 1/3" in runtime_diagnostics_test_source and "Runtime readiness checks ready: 1/2" in runtime_diagnostics_test_source and "Runtime readiness checks ready: 1/1" in runtime_diagnostics_test_source and "Runtime readiness next action: resolve Blocked fixture" in runtime_diagnostics_test_source and "Runtime readiness next action: inspect Unknown fixture" in runtime_diagnostics_test_source and "Runtime readiness next action: submit the system extension request" in runtime_diagnostics_test_source and "Bundle version match fixture: yes" in runtime_diagnostics_test_source and "Bundle version short mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle version build mismatch fixture: no" in runtime_diagnostics_test_source and "Bundle version missing fixture: no" in runtime_diagnostics_test_source and "Mach service direct fixture ready: yes" in runtime_diagnostics_test_source and "Mach service team-prefixed fixture ready: yes" in runtime_diagnostics_test_source and "Mach service unresolved fixture resolved: no" in runtime_diagnostics_test_source and "Mach service wrong fixture matches expected: no" in runtime_diagnostics_test_source and "Application group shared fixture ready: yes" in runtime_diagnostics_test_source and "Application group mismatched fixture ready: no" in runtime_diagnostics_test_source and "Application group unresolved fixture ready: no" in runtime_diagnostics_test_source and "Runtime diagnostics tests passed." in runtime_diagnostics_test_source,
            "runtime diagnostics test should cover blocked, unknown, and ready counted readiness rollups plus bundle-version, Mach-service, and app-group comparison",
            failures)
