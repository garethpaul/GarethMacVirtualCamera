...
ACTIONABLE_PATTERN = re.compile(
    r"warning:|error:|failed with a nonzero exit code|the following build commands failed:|testing failed:|\*\* BUILD FAILED \*\*|\*\* ARCHIVE FAILED \*\*|\*\* ANALYZE FAILED \*\*|\*\* CLEAN FAILED \*\*|\*\* INSTALL FAILED \*\*|\*\* TEST FAILED \*\*",
    re.IGNORECASE,
)
IGNORED_LINE_DISQUALIFYING_PATTERN = re.compile(
    r"warning:.*warning:|error:|failed with a nonzero exit code|the following build commands failed:|testing failed:|\*\* BUILD FAILED \*\*|\*\* ARCHIVE FAILED \*\*|\*\* ANALYZE FAILED \*\*|\*\* CLEAN FAILED \*\*|\*\* INSTALL FAILED \*\*|\*\* TEST FAILED \*\*",
    re.IGNORECASE,
)
